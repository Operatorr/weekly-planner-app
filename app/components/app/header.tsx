        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className="flex items-center justify-center gap-2 w-8 h-8 sm:w-auto sm:h-auto sm:pl-4 sm:pr-3 sm:py-1.5 rounded-[8px] bg-bone hover:bg-bone-dark transition-colors text-ink-muted hover:text-ink-light cursor-pointer"
            >
              <Search size={14} />
